...
public class SettingsWindow : Adw.PreferencesDialog {
	...
	public SettingsWindow() {
		...
		var group_majors = new Adw.PreferencesGroup();
		group_majors.title = _("Version Limits");
		page_filters.add(group_majors);
		...
		group_majors.add(row_prior_majors);
		...
		var row_interval_val = new Adw.ActionRow();
		row_interval_val.title = _("Check interval amount");
		...
		row_interval_val.add_suffix(spin_interval);
		group_notify.add(row_interval_val);
		...
		var row_interval_unit = new Adw.ComboRow();
		row_interval_unit.model = units_list;
		row_interval_unit.title = _("Check interval units");
		row_interval_unit.selected = (uint)App.notify_interval_unit;
		row_interval_unit.notify["selected"].connect(() => { App.notify_interval_unit = (int)row_interval_unit.selected; });
		group_notify.add(row_interval_unit);
